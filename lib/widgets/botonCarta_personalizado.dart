              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox( width: 200, child: Text(descripcion, maxLines: 3, overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'Comic Neue', fontSize: 17, color: Colors.black, overflow: TextOverflow.ellipsis))),
                    const SizedBox(height: 20),
                    Row(
